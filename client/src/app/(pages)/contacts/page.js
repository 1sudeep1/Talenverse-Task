                        ...
                        <div className='flex md:flex-row flex-col flex-wrap items-center justify-between md:gap-y-6 gap-y-4'>
                            <div className="p-2 md:w-1/2 w-full">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input type="text" id="name" name="name" className="w-full bg-[#2C3444] rounded border border-[#2E3545] focus:bg-white focus:text-black text-base text-gray-400 py-1 px-3 leading-8 duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2 md:w-1/2 w-full">
                                <div className="flex flex-col gap-1">
                                    <label htmlFor="email" className="leading-5 text-sm text-[#F9F9F9]">Email</label>
                                    <input type="email" id="email" name="email" className="w-full bg-[#2C3444] rounded border border-[#2E3545] focus:bg-white focus:text-black text-base text-gray-400 py-1 px-3 leading-8 duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2 md:w-1/2 w-full">
                                <div className="flex flex-col gap-1">
                                    <label htmlFor="phone" className="leading-5 text-sm text-[#F9F9F9]">Phone Number</label>
                                    <input type="text" id="phone" name="phone" className="w-full bg-[#2C3444] rounded border border-[#2E3545] focus:bg-white focus:text-black text-base text-gray-400 py-1 px-3 leading-8 duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2 md:w-1/2 w-full">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <Select
                                        ...
                                        styles={{
                                            ...
                                            singleValue: (baseStyles, state) => ({
                                                ...baseStyles,
                                                color: state.isFocused ? 'black' : '', // Change text color when not focused
                                            }),
                                        }}
                                    />
                                </div>
                            ...
                            <div className="p-2 w-full">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <textarea id="message" name="message" className="w-full bg-[#2C3444] rounded border border-[#2E3545] focus:bg-white focus:text-black text-base text-gray-400 py-1 px-3 leading-8 duration-200 ease-in-out h-[145px] md:h-[147px]" placeholder='Hi! We are Lookscout...' defaultValue={""} />
                                </div>
                            </div>
